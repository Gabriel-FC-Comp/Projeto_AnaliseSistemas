...
while opcaoMenu ~= -1
    disp("---------------------------------------------------------");
    disp("---------Projeto de Análise de Sistemas Lineares---------");
    disp("----------------Manipulador de Áudios V.1----------------");
    disp("---------------------------------------------------------");
    disp("---------------------------------------------------------");
    
    if(isempty(vozSinal) || isempty(ruidoSinal))
        
        disp("- 1 -> Gravar voz e ruído--------------------------------");
        disp("- 2 -> Sair----------------------------------------------");
        disp("---------------------------------------------------------");
        ...
        disp("- 1 -> Regravar áudios-----------------------------------");
        disp("- 2 -> Plotar os Sinais----------------------------------");
        disp("- 3 -> Manipular os Sinais-------------------------------");
        disp("- 4 -> Reproduzir os Sinais------------------------------");
        disp("- 5 -> Obter o SNR---------------------------------------");
        disp("- 6 -> Obter Espectros de Frequência---------------------");
        disp("- 7 -> Sair do programa----------------------------------");
        disp("---------------------------------------------------------");
        ...
        switch opcaoMenu
            ...
            case 3
                ...
                while manipulacao ~= -1
                    clc;
                    disp("-------------------Manipulando o Áudio-------------------");
                    disp("---------------------------------------------------------");
                    disp("- 1 -> Modular por uma exponencial negativa--------------");
                    disp("- 2 -> Clipping da amplitude-----------------------------");
                    disp("- 3 -> Inverter o sinal (reverso)------------------------");
                    disp("- 4 -> Adição de Echo------------------------------------");
                    disp("- 5 -> Reprodução e plotagem do sinal manipulado---------");
                    disp("- 6 -> Sair da manipulação-------------------------------");
                    disp("---------------------------------------------------------");
            ...
            case 4
                ...
                clc;
                disp("---------------Reproduzindo o(s) Áudio(s)----------------");
                disp("---------------------------------------------------------");
                disp("- 0 -> Tocar áudio da voz--------------------------------");
                disp("- 1 -> Tocar áudio do ruído------------------------------");
                disp("- 2 -> Tocar áudio do sinal somado-----------------------");
                disp("- 3 -> Tocar áudio do áudio melhor filtrado--------------");
                disp("- 4 -> Tocar áudio dos quatro sinais---------------------");
                disp("---------------------------------------------------------");
            ...
            case 6
                ...
                % espectro freq
                clc;
                disp("------------Obtendo o Espectro de Frequência-------------");
                disp("---------------------------------------------------------");
                disp("- 0 -> Plotar espectro da voz----------------------------");
                disp("- 1 -> Plotar espectro do ruído--------------------------");
                disp("- 2 -> Plotar espectro do sinal somado-------------------");
                disp("- 3 -> Plotar espectro do áudio melhor filtrado----------");
                disp("- 4 -> Plotar espectro dos quatro sinais-----------------");
                disp("---------------------------------------------------------");
