...
%% menu
selecao = menu("Selecione uma opção:", ...
    "Gravar voz", "Gravar ruído", "Carregar áudio já gravado", ...
    "Plotar Sinais", "Manipular Sinais", "Tocar áudios", "Calcular SNR", ...
    "Realizar Média Móvel usando Convolução", ...
    "Definir melhor intervalo de Filtragem", "Plotar Resultados", ...
    "Realizar Espectro de Frequência e plotar", "TUDO", "Sair");
...
switch(selecao)
    ...
    case 7
        calcularSNR();
    case 8
        mediaMovelConvolucao();
    case 9
        melhorIntervaloFiltragem();
    case 10
        plotResultados();
    case 11
        plotEspectro();
...
function melhorResultadoFiltro = melhorIntervaloFiltragem()
